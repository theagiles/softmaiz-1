...
def limpiar():
    fecha_produccion = Fecha_produccion.set("")
    identificaion=Identificaion.set("")
    mazorcas = Mazorcas.set("")
    mazorcasnocomercial=Mazorcasnocomercial.set("")
    mazorcascomercial=Mazorcascomercial.set("")
    nombres=Nombres.set("")
    apellidos=Apellidos.set("")
    edad=Edad.set("")
    correo=Correo.set("")
...
def registrarusu():
    ...
    Button(new,text="Registrar",bg='brown', font=("black",12),command=control).place(x=10,y=445)
    ...
    boton20 = tk.Button(new,text="Cerrar",bg='orange', font=("black",12),command=new.destroy).place(x=100,y=490)
...
def registrarProduccion():
    ...
    label_17=tk.Label(new,text="Fecha de produccion: ", font=("Agency FB",14)).place(x=10,y=45)
    entry_17 = tk.Entry(new,textvar=Fecha_produccion)
    entry_17.pack(padx=5,pady=5,ipadx=5,ipady=5)

    label_1=tk.Label(new,text="Identificacion: ", font=("Agency FB",14)).place(x=10,y=85)
    entry_1  = tk.Entry(new,textvar=Identificaion)
    entry_1 .pack(padx=5,pady=5,ipadx=5,ipady=5)

    label_11=tk.Label(new,text="Nombre: ", font=("Agency FB",14)).place(x=10,y=125)
    entry_11= tk.Entry(new,textvar=Nombres)
    entry_11.pack(padx=5,pady=5,ipadx=5,ipady=5)
    ...
    label_5=tk.Label(new,text="Total Mazorcas: ", font=("Agency FB",14)).place(x=10,y=200)
    ...
    label_2=tk.Label(new,text="Mazorcas comerciales: ", font=("Agency FB",14)).place(x=10,y=275)
    entry_2= tk.Entry(new,textvar=Mazorcascomercial)
    entry_2.pack(padx=5,pady=5,ipadx=5,ipady=5)

    label_3=tk.Label(new,text="Mazorcas no comerciales: ", font=("Agency FB",14)).place(x=10,y=315)
...
def consulta():
    ...
    password=Password.get()
    estado=Estado.get()
    db.Usuarios.find_one({"identificaion": identificaion})
    
    #nombres=Nombres.set(db.Usuarios.find_one({"nombres":nombres}))
...
def conteo():
    ...
    new.configure(background='sea green')
    new.title("Registrar Usuario")
    e3 = tk.Label(new,text="Busqueda y Conteo", bg="lawn green",fg="black").pack(padx=5,pady=5,ipadx=5,ipady=5,fill=tk.X)
    boton12 = tk.Button(new,text="Tomar foto",bg="orange", fg="black", command= tomarfoto).pack(side=tk.TOP,padx=5,pady=5,ipadx=5,ipady=5)
    boton23 = tk.Button(new,text="Busqueda",bg="orange", fg="black", command=abre).pack(side=tk.TOP,padx=5,pady=5,ipadx=5,ipady=5)
    boton32 = tk.Button(new,text="Verificar",bg="orange", fg="black", command=identidad).pack(side=tk.TOP,padx=5,pady=5,ipadx=5,ipady=5)
